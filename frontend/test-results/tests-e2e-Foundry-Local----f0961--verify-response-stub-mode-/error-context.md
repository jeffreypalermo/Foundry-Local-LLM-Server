...
- Name: tests\e2e.spec.ts >> Foundry Local - E2E Exploratory Testing >> Test 2: Send a prompt and verify response (stub mode)
...
- main [ref=e3]:
  ...
  - generic [ref=e11]:
    - textbox "Enter a prompt" [active] [ref=e12]: Explain why Gemma4 is useful for local LLM deployment
