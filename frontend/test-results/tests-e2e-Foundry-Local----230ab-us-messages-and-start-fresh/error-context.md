...
- Name: tests\e2e.spec.ts >> Foundry Local - E2E Exploratory Testing >> Test 6: Clear previous messages and start fresh
- Location: tests\e2e.spec.ts:157:3
...
- main [ref=e3]:
  ...
  - generic [ref=e11]:
    - textbox "Enter a prompt" [active] [ref=e12]: First conversation
