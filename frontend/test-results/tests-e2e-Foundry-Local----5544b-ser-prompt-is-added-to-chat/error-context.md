...
- Name: tests\e2e.spec.ts >> Foundry Local - E2E Exploratory Testing >> Test 3: Verify user prompt is added to chat
- Location: tests\e2e.spec.ts:73:3
...
- main [ref=e3]:
  ...
  - generic [ref=e11]:
    - textbox "Enter a prompt" [active] [ref=e12]: What is the benefit of using OpenAI-compatible APIs?
